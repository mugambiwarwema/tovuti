...
namespace tovuti.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        public static List<ApplicationLanguage> InitialLanguages => GetInitialLanguages();

        private readonly tovutiDbContext _context;

        private static List<ApplicationLanguage> GetInitialLanguages()
        {
            var tenantId = tovutiConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(tovutiDbContext context)
        {
            _context = context;
        }
