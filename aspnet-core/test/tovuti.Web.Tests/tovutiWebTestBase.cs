...
{
    public abstract class tovutiWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static tovutiWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(tovutiWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<tovutiDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<tovutiDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<tovutiDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<tovutiDbContext, Task<T>> func)
        {
            T result;
